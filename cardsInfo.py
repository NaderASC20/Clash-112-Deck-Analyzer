cardsInfo = {
    ...
    'Wall Breakers': {'name': 'Wall Breakers',
                      'elixir': 2,
                      'alert': 'NO INFO FROM ROAYLE API',
    ...
    'Royal Delivery': {'name': 'Royal Delivery',
                       'elixir': 7,
                       'alert': 'NO INFO FROM ROAYLE API',
